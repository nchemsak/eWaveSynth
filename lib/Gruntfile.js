...
module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    jshint: {
      ...
      options: {
        predef: ["document", "console", "Module", "$", "AudioContext", "MediaSource" ], //predefined
        esnext: true,
        globalstrict: true,
        globals: {"MediaRecorder": true, "QwertyHancock": true}, //put global variables here ex: {"Sandwich": true, "require": true}
        browserify: true
      }
    },
    sass: {
