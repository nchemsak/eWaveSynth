// "use strict";
// // if (!window.AudioContext) window.alert('you browser doesnt support Web Audio API');

// var soundBank = {};
//   var beats = {};
//   var tempo = QUERY.tempo || 120;
//   var signature = QUERY.signature || 4;
//   var beatDur = 60/tempo;
//   var barDur = signature * beatDur;
//   var clock, context, uiEvent;
...
//   uiEvent = clock.callbackAtTime(nextBeatTime(0))
//     .repeat(beatDur)
//     .tolerance({late: 100});
// });
